...
def main():
    ...
    project_name = project_cfg["tool"]["hatch"]["build"]["hooks"]["nativelib"]["pcfile"][0]["name"]
...
libdir=${prefix}/lib
""")
        f.write(f"""pkgconf_pypi_initpy={pkgconf_pypi_initpy}
...
Version: {project_cfg["project"]["version"]}""")
        ...
        f.write("""
Libs: -L${libdir} """ + f"-l{project_name}" + """
Cflags: -I${includedir}
""")
