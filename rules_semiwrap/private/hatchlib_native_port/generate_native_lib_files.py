...
from rules_semiwrap.private.hatchlib_native_port.config import PcFileConfig
from rules_semiwrap.private.hatchlib_native_port.validate import parse_input
...
class NativelibHook:
    def __init__(self, output_pcfile, output_libinit, config):
    ...
    def _generate_pcfile(
        ...
        version = pcfg.version or "noneya" # self.metadata.version
        if version:
